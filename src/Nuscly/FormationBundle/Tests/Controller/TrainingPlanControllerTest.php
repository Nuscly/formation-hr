...
class TrainingPlanControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $crawler = $client->request('GET', '/training-plan/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'trainingplan[name]' => 'Lorem ipsum dolor sit amet',
            'trainingplan[description]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/training-plan/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'trainingplan[name]' => 'Changed',
            'trainingplan[description]' => 'Changed',
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            'trainingplan_filter[name]' => 'First%',
            'trainingplan_filter[description]' => 'First%',
