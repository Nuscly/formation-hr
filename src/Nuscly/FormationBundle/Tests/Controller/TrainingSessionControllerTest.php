...
class TrainingSessionControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $crawler = $client->request('GET', '/training-session/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'trainingsession[numberOfDays]' => 10.99,
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/training-session/new');
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            'trainingsession_filter[numberOfDays]' => 10.99,
