...
class EmployeeControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'employee[name]' => 'Lorem ipsum dolor sit amet',
            'employee[surname]' => 'Lorem ipsum dolor sit amet',
            'employee[arrivalDate]' => new \DateTime(),
            'employee[arrivalReason]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            ...
            'employee[arrivalDate]' => new \DateTime(),
            'employee[arrivalReason]' => 'Changed',
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            'employee_filter[name]' => 'First%',
            'employee_filter[surname]' => 'First%',
            'employee_filter[arrivalDate]' => new \DateTime(),
            'employee_filter[arrivalReason]' => 'First%',
